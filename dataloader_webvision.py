...
class imagenet_dataset(Dataset):
    def __init__(self, root_dir, transform, num_class):
        root_dir1 = "C:/Users/Administrator/Desktop/DatasetAll/Red Mini-Imagenet"
        self.root = os.path.join(root_dir1, 'ILSVRC2012_img_val')
        ...
        if self.mode=='test':
            ...
            for line in lines:
                ...
                if target<num_class:
                    ...
                    num_samples += 1
                    self.noise_label.append(int(target))
