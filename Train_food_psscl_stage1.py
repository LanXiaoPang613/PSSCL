...
# C:\Users\Administrator\Desktop\DatasetAll\Food-101N_release
...
if __name__ == '__main__':
    ...
    scheduler1 = optim.lr_scheduler.CosineAnnealingLR(optimizer1, 120, 2e-4)
    scheduler2 = optim.lr_scheduler.CosineAnnealingLR(optimizer2, 120, 2e-4)
    ...
    second_ind = True
    temp_n_clean = warm_up-1 if warm_up > 0 else 0
    ...
    for epoch in range(resume_epoch, args.num_epochs + 1):
        ...
        if epoch < warm_up:
            ...
            superclean = []
            if temp_n_clean < args.num_clean:
                temp_n_clean += 1
                nclean = temp_n_clean
            else:
